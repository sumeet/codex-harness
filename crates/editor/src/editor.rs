...
impl Editor {
    ...
    pub fn highlighted_display_row_overlays(
        ...
        self.highlighted_display_row_overlays_in_range(
    ...
    pub fn highlighted_display_row_overlays_in_range(
        &self,
        ...
        self.row_overlays
            .values()
            .flat_map(|overlays| {
                let start_index = overlays.partition_point(|overlay| {
                    overlay
                        .range
                        .end
                ...
                let end_index = overlays.partition_point(|overlay| {
                    overlay
                        .range
                        .start
                ...
                overlays[start_index..end_index].iter().filter(|overlay| {
                    overlay
                        .range
                        .end
                        .cmp(&anchor_range.start, buffer_snapshot)
            ...
            .fold(BTreeMap::default(), |mut rows, overlay| {
                ...
                let mut end_row = if !overlay.range.end.is_max() && end.column() == 0 {
